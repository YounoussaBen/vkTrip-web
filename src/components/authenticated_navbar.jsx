      ...
      <div className="flex items-center justify-center gap-3">
       ...
       {toggle ? (
        ...
        <div className="items-center">
          ...
          <Link
            to="/logout">
             <button className="bg-[#605DEC] py-2 px-4 md:py-3 md:px-5 rounded-[5px] border-2 border-[#605DEC] text-base text-[#FAFAFA] hover:text-[#605DEC] hover:bg-white hover:border-2 hover:border-[#605DEC] transition-all duration-200"
