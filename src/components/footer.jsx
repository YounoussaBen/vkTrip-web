    ...
    <div className="lg:mt-28 flex flex-col gap-5 px-8">
      <div className="flex justify-between items-start flex-col md:flex-row gap-7">
        ...
        <ul className="flex flex-col items-start justify-start gap-3">
          ...
          <li className="footerLi">About vkTrip</li>
        ...
        <ul className="flex flex-col items-start justify-start  gap-3">
          ...
          <li className="footerLi">vkTrip for Android</li>
          <li className="footerLi">vkTrip for iOS</li>
      ...
      <div className="border-t-2 border-[#CBD4E6] py-8 flex justify-between items-center">
        <div className="flex items-center justify-center gap-3">
          <FaTwitter className="cursor-pointer w-5 h-5 sm:w-7 sm:h-7" />
          <FaInstagram className="cursor-pointer w-5 h-5 sm:w-7 sm:h-7" />
          <FaFacebook className="cursor-pointer w-5 h-5 sm:w-7 sm:h-7" />
        </div>
        <p className="text-[#7C8DB0] text-sm sm:text-base">&copy; 2023 vkTrip incorporated</p>
      </div>
    </div>
  );
};
